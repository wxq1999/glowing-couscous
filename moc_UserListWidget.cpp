...
#include "../../ImClient/UserListWidget.h"
...
const QMetaObject UserListWidget::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_UserListWidget.data,
      qt_meta_data_UserListWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *UserListWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UserListWidget.stringdata0))
        return static_cast<void*>(const_cast< UserListWidget*>(this));
