...
# Project:  ..\ImServer\ImServer.pro
# Template: app
# Command: C:\Qt\Qt5.6.0\5.6\mingw49_32\bin\qmake.exe -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" -o Makefile ..\ImServer\ImServer.pro
#############################################################################
...
Makefile: ../ImServer/ImServer.pro C:/Qt/Qt5.6.0/5.6/mingw49_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.6.0/5.6/mingw49_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" -o Makefile ..\ImServer\ImServer.pro
