...
QT_MOC_LITERAL(1, 11, 11), // "UM_CHAT_C2S"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 15), // "const ChatInfo*"
QT_MOC_LITERAL(4, 40, 21) // "on_buttonSend_clicked"

    },
    "ChatWindow\0UM_CHAT_C2S\0\0const ChatInfo*\0"
...
void ChatWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->UM_CHAT_C2S((*reinterpret_cast< const ChatInfo*(*)>(_a[1]))); break;
        ...
        {
            typedef void (ChatWindow::*_t)(const ChatInfo * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ChatWindow::UM_CHAT_C2S)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChatWindow::UM_CHAT_C2S(const ChatInfo * _t1)
{
